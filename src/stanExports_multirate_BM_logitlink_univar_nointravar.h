...
namespace model_multirate_BM_logitlink_univar_nointravar_namespace {
using std::istream;
using std::string;
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_multirate_BM_logitlink_univar_nointravar");
    reader.add_event(198, 196, "end", "model_multirate_BM_logitlink_univar_nointravar");
    return reader;
}
template <typename T0__, typename T1__, typename T2__, typename T10__, typename T13__, typename T14__, typename T15__, typename T16__>
typename boost::math::tools::promote_args<T0__, T1__, T2__, T10__, typename boost::math::tools::promote_args<T13__, T14__, T15__, T16__>::type>::type
prune(const Eigen::Matrix<T0__, Eigen::Dynamic, 1>& alpha,
          ...
          const Eigen::Matrix<T10__, Eigen::Dynamic, Eigen::Dynamic>& Y,
          const std::vector<int>& n_inc,
          const std::vector<int>& pos_inc,
          const Eigen::Matrix<T13__, Eigen::Dynamic, 1>& t,
          const Eigen::Matrix<T14__, Eigen::Dynamic, Eigen::Dynamic>& U,
          const Eigen::Matrix<T15__, Eigen::Dynamic, Eigen::Dynamic>& W,
          const Eigen::Matrix<T16__, Eigen::Dynamic, Eigen::Dynamic>& Z,
    ...
    typedef typename boost::math::tools::promote_args<T0__, T1__, T2__, T10__, typename boost::math::tools::promote_args<T13__, T14__, T15__, T16__>::type>::type local_scalar_t__;
    ...
    try {
        ...
        Eigen::Matrix<local_scalar_t__, Eigen::Dynamic, 1> L(T);
        stan::math::initialize(L, DUMMY_VAR__);
        stan::math::fill(L, DUMMY_VAR__);
        current_statement_begin__ = 17;
        local_scalar_t__ max_L(DUMMY_VAR__);
        (void) max_L;  // dummy to suppress unused var warning
        stan::math::initialize(max_L, DUMMY_VAR__);
        stan::math::fill(max_L, DUMMY_VAR__);
        current_statement_begin__ = 20;
        if (as_bool(get_base1(dims(gamma), 1, "dims(gamma)", 1))) {
            current_statement_begin__ = 21;
            stan::math::assign(r, elt_multiply(t, add(elt_multiply(stan::math::exp(multiply(U, alpha)), inv_logit(multiply(W, beta))), stan::math::exp(multiply(Z, gamma)))));
        } else {
            current_statement_begin__ = 23;
            stan::math::assign(r, elt_multiply(t, elt_multiply(stan::math::exp(multiply(U, alpha)), inv_logit(multiply(W, beta)))));
        }
        ...
        stan::math::assign(L, stan::model::rvalue(R, stan::model::cons_list(stan::model::index_multi(ind_root), stan::model::nil_index_list()), "R"));
        current_statement_begin__ = 122;
        stan::math::assign(max_L, max(L));
        current_statement_begin__ = 123;
        stan::math::assign(L, stan::math::exp(subtract(L, max_L)));
        current_statement_begin__ = 128;
        return stan::math::promote_scalar<fun_return_scalar_t__>(((stan::math::log(dot_self(L)) - stan::math::log(sum(L))) + max_L));
        }
...
struct prune_functor__ {
    ...
    operator()(const Eigen::Matrix<T0__, Eigen::Dynamic, 1>& alpha,
        ...
        return prune(alpha, beta, gamma, N, K, T, E, C, n_obs, ind_obs, Y, n_inc, pos_inc, t, U, W, Z, n_des, ind_des, pos_des, ind_tip, ind_root, ind_prune, n_dim, ind_dim, pos_dim, code_obs, code_tip, code_nod, pstream__);
    }
};
#include <stan_meta_header.hpp>
class model_multirate_BM_logitlink_univar_nointravar
  : public stan::model::model_base_crtp<model_multirate_BM_logitlink_univar_nointravar> {
private:
        int N;
        int K;
        int T;
...
public:
    model_multirate_BM_logitlink_univar_nointravar(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_multirate_BM_logitlink_univar_nointravar_namespace::model_multirate_BM_logitlink_univar_nointravar";
        ...
        try {
            ...
            validate_non_negative_index("U", "sum(n_inc)", sum(n_inc));
            validate_non_negative_index("U", "A", A);
            context__.validate_dims("data initialization", "U", "matrix_d", context__.to_vec(sum(n_inc),A));
            U = Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic>(sum(n_inc), A);
            vals_r__ = context__.vals_r("U");
            pos__ = 0;
            size_t U_j_2_max__ = A;
            size_t U_j_1_max__ = sum(n_inc);
    ...
    ~model_multirate_BM_logitlink_univar_nointravar() { }
    ...
    T__ log_prob(std::vector<T__>& params_r__,
        ...
        try {
            ...
            lp_accum__.add(prune(alpha, beta, gamma, N, K, T, E, C, n_obs, ind_obs, Y, n_inc, pos_inc, t, U, W, Z, n_des, ind_des, pos_des, ind_tip, ind_root, ind_prune, n_dim, ind_dim, pos_dim, code_obs, code_tip, code_nod, pstream__));
        } catch (const std::exception& e) {
            stan::lang::rethrow_located(e, current_statement_begin__, prog_reader__());
            // Next line prevents compiler griping about no return
            throw std::runtime_error("*** IF YOU SEE THIS, PLEASE REPORT A BUG ***");
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_multirate_BM_logitlink_univar_nointravar_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
    ...
    std::string model_name() const {
        return "model_multirate_BM_logitlink_univar_nointravar";
    }
...
typedef model_multirate_BM_logitlink_univar_nointravar_namespace::model_multirate_BM_logitlink_univar_nointravar stan_model;
#ifndef USING_R
