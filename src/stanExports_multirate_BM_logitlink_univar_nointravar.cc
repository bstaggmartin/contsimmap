...
#include "stanExports_multirate_BM_logitlink_univar_nointravar.h"

RCPP_MODULE(stan_fit4multirate_BM_logitlink_univar_nointravar_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("rstantools_model_multirate_BM_logitlink_univar_nointravar")
