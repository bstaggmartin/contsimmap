...
namespace model_multirate_BM_loglink_univar_nointravar_namespace {
using std::istream;
using std::string;
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_multirate_BM_loglink_univar_nointravar");
    reader.add_event(194, 192, "end", "model_multirate_BM_loglink_univar_nointravar");
    return reader;
}
...
class model_multirate_BM_loglink_univar_nointravar
  : public stan::model::model_base_crtp<model_multirate_BM_loglink_univar_nointravar> {
private:
        int N;
        int K;
        int T;
...
public:
    model_multirate_BM_loglink_univar_nointravar(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_multirate_BM_loglink_univar_nointravar_namespace::model_multirate_BM_loglink_univar_nointravar";
    ...
    ~model_multirate_BM_loglink_univar_nointravar() { }
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_multirate_BM_loglink_univar_nointravar_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
    ...
    std::string model_name() const {
        return "model_multirate_BM_loglink_univar_nointravar";
    }
...
typedef model_multirate_BM_loglink_univar_nointravar_namespace::model_multirate_BM_loglink_univar_nointravar stan_model;
#ifndef USING_R
