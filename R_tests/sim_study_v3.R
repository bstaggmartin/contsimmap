...
foo<-function(df.row){
  ...
  lapply(names(alpha.formulae),function(j) contsimmap::fit.model(tmp.dat,
...
saveRDS(df,paste0('/mnt/gs18/scratch/users/mart2121/contsimmap_sim_study_',Sys.Date()))
